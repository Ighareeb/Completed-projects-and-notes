...
// const inventorsBirthdayOldToYoung = inventors.sort((a, b)=>{
// 	return a.year - b.year;
// });
// console.log(inventorsBirthdayOldToYoung);

// 4. How many years did all the inventors live all together?
// const totalYears = inventors.reduce((acc, current)=>{
// 	return acc + (current.passed - current.year);
// }, 0);
// console.log(totalYears);

// 5. Sort the inventors by years lived
// const inventorsYearsLived = inventors.sort((a, b) => {
...
// 	let [lastA, firstA] = a.split(',');
// 	let [lastB, firstB] = b.split(',');
...
const sumInstances = data.reduce((acc, current) => {
	if (!acc[current]) {
		acc[current] = 0;
	}
	acc[current]++;
