	...
	_createKeys(){
		...
		keyLayout.forEach(key=>{
			...
			switch(key){
				...
				case 'caps':
					keyElement.classList.add('keyboard_key_wide', 'keyboard_key-activatable');
				...
				case 'done':
					keyElement.classList.add('keyboard_key_wide', 'keyboard_key-dark');
...
window.addEventListener('DOMContentLoaded', function(){
	Keyboard.init();
	Keyboard.open('type', function(currentValue){
		console.log('value changed! it is now: ' + currentValue);
